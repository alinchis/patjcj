<template>
  <div>
    ...
    <q-layout view="hHh lpR fFf" class="aller-font" v-if="$q.platform.is.desktop">
    ...
    <q-layout view="hHh lpR fFf" class="aller-font" v-if="$q.platform.is.mobile">
      <pictures-gallery></pictures-gallery>
      <q-header
          elevated
          id="header-mobile"
        ...
        computed: {
            ...
            ...mapState({
                ...
                monumentInfoShown:
                    {
                        get: (state) => {
                            return state.monuments.monumentDisplayed &&
