      ...
      >
        <q-card>
          <q-card-section class="column bg-grey-4">
            ...
            <q-btn flat no-caps label="Arhiva poze [JPG @17.7GB]" align="between" type="a" href="https://www.myqnapcloud.com/smartshare/6h8f83m54l6p709vu494x222_69Bp2H5" target="_blank"/>
          </q-card-section>
        </q-card>
      </q-expansion-item>
